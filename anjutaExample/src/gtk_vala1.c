/* gtk_vala1.c generated by valac 0.36.1.47-a667b, the Vala compiler
 * generated from gtk_vala1.vala, do not modify */
...
static GParamSpec* main_properties[MAIN_LAST_PROPERTY];
...
#define MAIN_UI_FILE "src/gtk_vala1.ui"
Main* main_new (void);
